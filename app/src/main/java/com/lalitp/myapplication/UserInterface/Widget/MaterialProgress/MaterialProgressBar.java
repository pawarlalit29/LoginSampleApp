...
public class MaterialProgressBar extends ImageView {
    ...
    public void setBackgroundColor(@ColorRes int colorRes) {
        if (getBackground() instanceof ShapeDrawable) {
            final Resources res = getResources();
            ((ShapeDrawable) getBackground()).getPaint().setColor(ContextCompat.getColor(LoginSampleApp.getAppContext(),colorRes));
        }
    }
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            //System.out.println((viewWidth / 2 + " " +  viewHeight / 2+ " " +  (mCircleDiameter / 2 + " " +  mShadowRadius));
